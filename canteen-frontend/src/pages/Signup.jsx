        ...
        <div className="min-h-screen bg-white flex items-center justify-center p-6">
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-black text-secondary tracking-tight">Join Canteen.</h1>
                    <p className="text-text-muted mt-3 font-medium">Create your account to start ordering.</p>
                </div>
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div>
                        <label className="block text-sm font-black text-secondary uppercase tracking-widest mb-2">Full Name</label>
                        <input
                            type="text"
                            required
                            value={name}
                    ...
                    >
                        {loading ? 'Creating Account...' : 'Sign Up'} <ArrowRight size={24} />
                    </button>
                </form>
